...
try {
    ...
    Push-TestCaseResult -Outcome 'Fail' -Name "pipeline_TestPackageExecution" -Duration ((Get-Date) - $scriptStart) -Message "Test Package execution finished." -TestAspect Execution
} catch {
